...
import { absoluteUrl, getDocOgPath, publicAssetFallbackPath, site } from '@/lib/site';
import '@/styles/app.css';

export const Route = createRootRoute({
  head: () => {
    const rootOgImage = getDocOgPath([]);
    ...
    return {
      ...
      links: [
        ...
        { rel: 'alternate', href: absoluteUrl(site.llmsUrl), title: 'LSPilot LLM Index', type: 'text/plain' },
      ],
    };
  },
